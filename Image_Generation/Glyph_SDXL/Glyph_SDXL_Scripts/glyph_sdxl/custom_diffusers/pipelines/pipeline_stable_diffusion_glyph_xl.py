...
class StableDiffusionGlyphXLPipeline(StableDiffusionXLPipeline):
    ...
    def __init__(
        ...
        self.loaded_prompt_embeds = None
        self.loaded_negative_prompt_embeds = None
        self.loaded_pooled_prompt_embeds = None
        self.loaded_negative_pooled_prompt_embeds = None
        self.loaded_byt5_prompt_embeds = None
        self.loaded_negative_byt5_prompt_embeds = None
        ...
        **kwargs,
        ...
        if (loaded_ip_adapter_img != ip_adapter_image or loaded_clip_vision != image_encoder_type) and image_encoder_type != 'None':
            ...
            image_embeds, negative_image_embeds = self.encode_image(
                ip_adapter_image, device, num_images_per_prompt, output_hidden_state, image_encoder_type, dtype=dtype
            )
            if do_classifier_free_guidance:
        ...
        if loaded_prompt_and_bboxes != [prompt + text_prompt, bboxes]:
            ...
            if debug:
                print('\033[93m', 'Process attention masks.', '\033[0m')
        ...
        if not output_type == "latent":
            ...
            # image = latents
            image = {"samples": latents / self.vae.config.scaling_factor}
